...
#rating-5:checked ~ .emoji-wrapper > .emoji { transform: translateY(-500px); }
        ...
        <div class="container">
      <form action="<?= base_url('transaksi_customer/save_ratting') ?>" method="post">
        <div class="form-group">
    <label for="exampleInputPassword1">Boleh dong minta komentarnya </label>
    <!-- author design ratting star :Mert Cukuren -->
    <div class="rating" id="exampleModal">
    ...
    <input type="hidden" name="id_customer" id="" value="<?= $customer['id'] ?>">
    <?php
    $uri = $this->uri->segment(3);
    $query = $this->db->query("SELECT * FROM transaksi JOIN detail_transaksi WHERE transaksi.id='$uri' AND detail_transaksi.id_transaksi=transaksi.id")->result_array();
    foreach ($query as $key => $value):?>
    <input type="hidden" name="id_product[]" id="" value="<?= $value['id_product'] ?>">
    <?php endforeach; ?>
    <textarea name="komentar" id="" class="form-control col-md-5 mx-auto" cols="5" rows="5"></textarea><br>
    <div class="button" class="mx-auto" style="text-align:center;">
